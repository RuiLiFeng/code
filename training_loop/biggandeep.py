...
def training_loop(config: Config):
    ...
    with tf.device('/cpu:0'):
        ...
        data_iter = Network.input_data_as_iter(batch_size=config.batch_size, seed=config.seed, mode="train")
        eval_iter = Network.input_data_as_iter(batch_size=config.batch_size, seed=config.seed, mode="eval")
